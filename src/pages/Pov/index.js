...
const PovPage = () => {
  ...
  return (
    <Layout className="layout currentMap-page" style={style.layout}>
      <Sidebar
      ...
      <AlertComponent msg={successTextAlert} onClose={setSuccessTextAlert} />

      <ZoomWrapper style={style} handleZoom={handleZoom} />
    </Layout>
  );
};
